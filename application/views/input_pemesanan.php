                ...
                <div class="col-3">
                    <nav id="sidebar">
                        ...
                        <ul>
                            ...
                            <li class="menu"><a class="current" style="text-decoration : none;" href="<?php echo base_url()?>ControllerKaryawan/input_pemesanan"><img src="../assets/image/b.png">Input Data Pemesanan</a></li>
