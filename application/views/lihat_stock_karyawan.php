                ...
                <div class="col-3">
                    <nav id="sidebar">
                        ...
                        <ul>
                            ...
                            <li class="menu"><a class="current" style="text-decoration : none;" href="<?php echo base_url()?>ControllerKaryawan/lihat_stock_karyawan"><img src="../assets/image/2.png">Lihat Stock Barang</a></li>
