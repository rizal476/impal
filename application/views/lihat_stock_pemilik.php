                ...
                <div class="col-3">
                    <nav id="sidebar">
                        ...
                        <ul>
                            ...
                            <li class="menu"><a class="current" style="text-decoration : none;" href="<?php echo base_url()?>pemilik_controller/lihat_stock"><img src="../assets/image/1.png">Lihat Stock Barang</a></li>
