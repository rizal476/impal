                ...
                <div class="col-3">
                    <nav id="sidebar">
                        ...
                        <ul>
                            ...
                            <li class="menu"><a class="current" style="text-decoration : none;" href="<?php echo base_url()?>ControllerPemilik/lihat_terjual"><img src="../assets/image/6.png">Lihat Barang Terjual</a></li>
                ...
                <div class="col-9">
                    <div class="row">
                        ...
                        <div class="col mx-auto">
                            ...
                            <form method="post" action="<?php echo base_url()?>ControllerPemilik/lihat_terjual2" style="margin-top:50px;">
